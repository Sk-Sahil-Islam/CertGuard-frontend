...
function CertificateDetails({ metadata, issuedAt, isValid = true }) {
    ...
    <div className="certificate-container">
      ...
      <div className="certificate-body">
        ...
        <div className="certificate-details">
          ...
          <div className="detail-item">
            ...
            <span className="detail-value">{formatDate(issuedAt)}</span>
          </div>
      ...
      <div className="certificate-footer">
        <div className="certificate-seal">
          <svg className="seal-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
            <polyline points="22 4 12 14.01 9 11.01"></polyline>
          </svg>
        </div>
